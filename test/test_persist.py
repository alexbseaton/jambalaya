...
class TestPersist(unittest.TestCase):
    ...
    def test_random_sample(self):
        ...
        for sample in b[pick]:
            print('\nDeparture date: {}\nPrice: {}\nFrom: {}\nTo: {}\nAirline: {}'.format(sample.departure_date,
                                                                                          sample.price,
                                                                                          sample.departure_location,
                                                                                          sample.arrival_location,
                                                                                          sample.airline))
    ...
    def _create_leg(self):
        ...
        return Leg(price=20.0, departure_location='DEP', arrival_location='ARR',
                   departure_date=download_day + datetime.timedelta(days=10), request_time=download_day,
                   duration=datetime.timedelta(hours=2), airline='Qantas')
